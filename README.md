...
1. 48位家长报名系统上不愿修改为第三类房产积分，深高级也就不做初审，所以系统停留在“待（学校）初审”状态，职能部门审核也就全部没有开展。
2. 6.29 17:00 发布积分，5小区如何处理、其他单身宿舍、公寓类小区如何处理……拭目以待！希望教育局做出一个公开、公平、公正的决策。

## 事件详情

### 6.29 - 周一 - 第32天

**今天 17:00 福田初一报名系统正式发布积分核算结果。在此向各商住、工业等用地上的单身宿舍、公寓等业主征集今天的核算结果爆料及证据。**
