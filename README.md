...
- 5.29，福田区高级南学校初审阶段最后一天，将香蜜和沙头街道的8个小区审批为不通过，说请示了区教育局因土地性质原因要从一类（80分）降为三类（70分）。
- 5.31，8小区组织签名、按手印、递交申诉书，第一现场采访并引出“千万豪宅要求踢出老破小”的说法。
- 6.1，区教育局副局长接访每个小区5名代表，提出三居住（土地用途、房屋用途、实际）原则，并恢复了3个小区的一类资格，另5个小区部分家长当晚跪求学位，然被强制带离。
- 6.2，区教育局田局长接访5小区所有家长，表示今年开始新增土地性质作为是否一类的标准。
- 6.3，报名系统增加了“公寓、宿舍……”三栏，并要求家长修改。
- 6.4，田局在街道接访今年报名上学的家长，上午21家、下午27家，说“全区中小学统一执行”。
- 6.10，财富广场上午发生聚众唱歌，多人被拘留（5-7天）。
- 6.12，幸福福田公众号发布官宣文章，引发下午的华强片区同类小区聚集表达情绪，报名系统当晚删去了新增的“公寓、宿舍……”三栏。
- 6.12-6.18，社区接访，强调降级政策全市执行！
- 6.15，《福田区现状工业区分区划定》（征求意见稿）公示
- 6.20，附近中介开始受到严查和训诫。
- 6.22，陈如桂市长接访家长并表态24号常委会讨论。
- 6.22-23，福田区小一报名系统发布“职能部门审核结果”和积分结果 —— 相关小区仍按80分计算。
- 6.24-29，福田区初一报名系统发布“职能部门审核结果”和积分结果 —— 相关小区全部为“未审核”。
    - 48位家长报名系统上不愿修改为第三类房产积分，深高级也就不做初审，所以系统停留在“待（学校）初审”状态，职能部门审核也就全部没有开展。

6.29 17:00 发布积分，5小区如何处理、其他单身宿舍、公寓类小区如何处理……拭目以待！希望教育局做出一个公平、公正的决策。
